...
const operational = { secretStoreReference: 'TEST_BOT', storePath: 'state.sqlite', custody, killSwitchEngaged: false, notificationReady: true, chainVerification: 'verified' as const, lastReconciliationAt: '2026-08-28T00:00:00.000Z', observedAt: '2026-08-28T00:00:00.000Z', expiresAt: '2099-01-01T00:00:00.000Z' };
