...
export interface OperationalReadiness { secretStoreReference?: string; storePath?: string; custody: CustodyReadiness; killSwitchEngaged: boolean; notificationReady: boolean; chainVerification: ChainVerificationStatus; lastReconciliationAt: string; observedAt: string; expiresAt: string; }
