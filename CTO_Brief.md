...
The product must remain execution-first in Phase 1, with the CLI as the only operator surface. Read-only intelligence, readiness, calendar, reminder, and Telegram notification surfaces begin in Phase 2. Campaigns, fire lanes, operational controls, and approval commands begin in Phase 3. Opportunity evidence and qualified replication expand in Phase 4. Analytics and the full dashboard begin in Phase 5. This is consistent with the PM and design documents and is a hard scope boundary. No chain is considered live merely because its evidence has been accepted; code, fork/integration tests, and operational gates must pass first.
